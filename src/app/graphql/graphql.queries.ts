...
const FIND_USER_LIST = gql`
  query FindUserList($users: [UserListInput!]!){
    findUserList(users: $users){
      id,
      name,
      id_section
    }
...
export { FIND_USER_LIST, GET_GROUP_INTERACTIONS, USERS_INTERACTION, USER_INTERACTION, USER_CHAT, USER_INTERACTION_BY_UID_PROFILE, FIND_GROUP, USER_CHAT_GROUP, All_USER_WITHIN_GROUP }